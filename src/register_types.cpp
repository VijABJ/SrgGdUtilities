...
void initialize_utility_objects_module(ModuleInitializationLevel p_level)
{
    ...
    //ClassDB::register_class<FilesSource>();
    //ClassDB::register_class<FilesSourceWithOverride>();
    
    ClassDB::register_class<ConfigSetting>();
    ClassDB::register_class<ConfigSettings>();
    ClassDB::register_class<ConfigStore>();

    ClassDB::register_class<NamedStatistic>();
